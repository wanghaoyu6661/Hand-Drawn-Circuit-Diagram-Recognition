# -*- coding: utf-8 -*-
"""
clean_with_yolov9_gray_expand.py
完全替代 lama 逻辑 —— 使用灰色矩形覆盖
并且同步 remove_components.py 中的 expand_bbox 逻辑
"""
...
def main():
    IMG_DIR = "/root/autodl-tmp/final_result/src_img"
    LABEL_DIR = "/root/autodl-tmp/final_result/yolo_detect/exp/labels"
    OUT_DIR = "/root/autodl-tmp/final_result/lama_clean"
